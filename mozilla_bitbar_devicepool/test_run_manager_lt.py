...
class TestRunManagerLT(object):
    ...
    def run_single_project_single_thread_multi_job(self):
        ...
        while self.state == RUNNING:
            ...
            if tc_job_count <= 0:
                ...
                jobs_to_start = min(tc_job_count, self.max_jobs_to_start)
                for i in range(jobs_to_start):
                    ...
                    if self.test_mode:
                        ...
                        # TODO: background so we can do this faster
    ...
    def run_single_project_single_thread_single_job(self):
        # base on __file__ to get the project root dir
        project_source_dir = os.path.dirname(os.path.realpath(__file__))
        project_root_dir = os.path.abspath(os.path.join(project_source_dir, ".."))
        user_script_golden_dir = os.path.join(
...
if __name__ == "__main__":
    ...
    # trmlt.run_single_project_single_thread_single_job()
