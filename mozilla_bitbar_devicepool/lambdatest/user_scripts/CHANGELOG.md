...
| v8 | `v8-disable-scrcpy-video/` | Deployed | Disables scrcpy video (`video: false`). Default as of PR #104. Based on v5. |
| v9 | `v9-disable-livevideo/` | Not deployed | Also disables scrcpy live video (`liveVideo: false`) in addition to `video: false`. Testing on test-1 pool. Based on v8. |
