...
def main():
    parser = argparse.ArgumentParser(description="Compare Bitbar API devices to config devices")
    parser.add_argument(
        "--config-file",
        "-c",
        dest="config_file",
        default=None,
        help="Path to device config file (default: use DeviceGroupReport default)",
    )
